...
int findPosition(int val,Node *&head)
{
...
void insertAtValue(int val,Node *&head,Node *&tail,int data){
    int pos=findPosition(val,head);
...
int main()
{
    ...
    displayList(head);
     ...
     insertAtValue(28,head,tail,45);
     displayList(head);

     cout<<"\nBefore Deletion\n";
    displayList(head);

    deleteByValue(45,head,tail);
    cout<<"\nAfter Deletion\n";
    displayList(head);
    return 0;
}
